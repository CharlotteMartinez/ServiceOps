...
export interface CreateActivitySupportTicketInput {
    ...
    attachments?: string[]; // Hình ảnh/Tệp đính kèm dạng base64 (field "Hình ảnh/Tệp đính kèm" trên Teable)
}
...
export async function createActivitySupportTicket(input: CreateActivitySupportTicketInput): Promise<ApiResponse<{ id: string }>> {
    ...
    const body = {
        ...
        attachments: input.attachments || [], // Hình ảnh/Tệp đính kèm dạng base64
        assignee: assignee,
